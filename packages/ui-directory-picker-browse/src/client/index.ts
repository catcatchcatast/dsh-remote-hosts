...
/** Required services (cordis fiber inject): slots, the rc1 workspace wire, and locale. */
  ...
  ctx.effect(() => {
    ...
    const dictionaries: [locale: string, dict: Record<string, string>][] = [
      ['zh', {
        'browser.title': '新建项目',
        'browser.host': '主机',
        'browser.hostLoading': '正在读取主机…',
        'browser.hostHint': '选择目录所在的主机',
        'browser.hostUnavailable': '主机选择暂不可用',
        'browser.home': '主目录',
        'browser.sourceFolder': '源文件夹',
        'browser.up': '上一级',
        'browser.roots': '文件系统根目录',
      ...
      ['en', {
        ...
        'browser.host': 'Host',
        'browser.hostLoading': 'Loading hosts…',
        'browser.hostHint': 'Choose the Host that owns this directory',
        'browser.hostUnavailable': 'Host selection is unavailable',
        'browser.home': 'Home',
        'browser.sourceFolder': 'Source folder',
        'browser.up': 'Up one level',
        'browser.roots': 'Filesystem roots',
